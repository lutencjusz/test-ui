...
const initialData = {
    tasks: {
        "task-1": { id: "task-1", content: "Tariff", setCategoryElements: "Tariff", isDragDisabled: true, category:"*"},
        "task-2": { id: "task-2", content: "SLA", setCategoryElements: "SLA", category:"*", isDragDisabled: true},
        "task-3": { id: "task-3", content: "Offer", setCategoryElements: "Offer", category:"*", isDragDisabled: true},
        "task-4": { id: "task-4", content: "Tariff: Element 4", category:"Tariff"},
        "task-5": { id: "task-5", content: "Tariff: Element 5", category:"Tariff" },
        ...
        "task-11": { id: "task-11", content: "Other: Element 11", category:"Offer"},
